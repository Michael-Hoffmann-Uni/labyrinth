...
public class PlayerKI4 implements Player {
    private Color color;
    ...
    public GameState requestActionGamePiece() {
        /* Wenn das gesuchte Symbol eingesammelt werden kann wird dies getan. Ansonsten wird stehen geblieben */
        ...
        /* bleibt an aktueller Position stehen */
        return gameState.changeBoardGamePiece(color, gameState.getPositionX(color), gameState.getPositionY(color));
    }
